(function (
	...
	*/
	...
	function initGoo() {
		...
		var gooRunner = new goo.GooRunner({"alpha": true, "useDevicePixelRatio": false, "manuallyStartGameLoop": true, "antialias": true, "logo": false});
		...
		gooRunner.world.add(new goo.Dom3dSystem(gooRunner.renderer));
