(function (angular, undefined) {
  ...
  angular.module('finnplay.common.utils.ngRetina', []).config([
    '$provide',
    function ($provide) {
  ...
  .directive('ngSrc', function ($window, $http, Fn) {
      ...
      return function (scope, element, attrs) {
        ...
        attrs.$observe('ngSrc', function (value) {
          if (!value)
            return;
          var is2x = isRetina && (angular.isUndefined(attrs.noretina) || !attrs.noretina) /*&& typeof $window.sessionStorage === 'object'*/ && element[0].tagName === 'IMG' && !value.match(data_url_regex),
            anyway2x = attrs.retina === 'true';
